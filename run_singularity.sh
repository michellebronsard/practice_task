...
singularity shell --bind "${STATALIC}":/usr/local/stata/stata.lic,"${DROPBOX}":/home/statauser/dropbox,"${GITHUB_KEY}":/home/statauser/.ssh,"$(pwd)":/home/statauser/template /home/groups/gentzkow/${USER}/simg/template_latest.sif
